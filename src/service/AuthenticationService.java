...
public class AuthenticationService {
    ...
    // กำหนดพาร์ทของไฟล์ CSV (ถ้าหาไฟล์ไม่เจอ ให้ลองเปลี่ยนเป็น "src/users.csv")
    private static final String FILE_PATH = "C:\\Users\\wutth\\Downloads\\RegisterSoftware-main\\RegisterSoftware-main\\src\\data\\users.csv"; 
    ...
    public String login(String username, String password) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(FILE_PATH))) {
            ...
            System.out.println("เกิดข้อผิดพลาดในการอ่านไฟล์ CSV: " + e.getMessage());
        }
